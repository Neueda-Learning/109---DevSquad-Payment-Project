    ...
    <div className="page">
      <div className="page-header">
        ...
        <div className="page-header-actions">
          <Link to="/payments/new" className="home-cta">
            <svg
              ...
              height="36px"
            >
              <rect width={36} height={36} x={0} y={0} fill="#2563eb" />
              <path
                fill="#e53935"
            ...
            <span className="now">Pay Now!</span>
            <span className="play">New Payment</span>
          </Link>

          <Link to="/scheduled/new" className="home-cta home-cta-reverse">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 36 36"
              width="36px"
            ...
            <span className="now">Pay Later!</span>
            <span className="play">Schedule Payment</span>
          </Link>
        </div>
      </div>
